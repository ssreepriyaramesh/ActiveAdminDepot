...
public class CustomSoftAssert extends Assertion {
	...
	public String saveScreenshot(String strCName) throws IOException {
		TakesScreenshot ts = (TakesScreenshot) TestBaseClass.driver;
		File source = ts.getScreenshotAs(OutputType.FILE);
		Random rdm = new Random();
		int num = rdm.nextInt(9999);
		String dest = System.getProperty("user.dir") + "/SaveScreenshot/" + "err" + num + ".png";
